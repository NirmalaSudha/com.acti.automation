...
/*
 * Name:DriverScript
 * Description:This class is responsible for loading the properties file and forloading the application
...
public class DriverScript {
	...
	public DriverScript()
	{
			 ...
			 
		{
		 ...
		 {
			 System.err.println("the browser parameter is not supported pleasecheck the config file");
		 }
